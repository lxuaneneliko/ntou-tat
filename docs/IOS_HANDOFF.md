...
- macOS、Xcode 26+、Node.js 24+；iOS 16.4 起，iPhone／iPad。
- App 最低版本高於 Capacitor 的 iOS 15：共用登入辨識引擎使用 WebAssembly SIMD，搭配現有 CSS／Vite 瀏覽器基準，需要 iOS 16.4 的 WebKit。參考 [Safari 16.4 更新](https://webkit.org/blog/13966/webkit-features-in-safari-16-4/)。
